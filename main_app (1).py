...
Original file is located at
    https://colab.research.google.com/drive/1a7XJqlDTsz_xfYKXUGZ26Im5Pqq0MK19
"""
...
def main():
  ...
  if video_file is not None:
    ...
    if file_is_of_right_size(file_size):
      ...
      st.subheader('The video is too large, another one')

if __name__ == '__main__':
  st.title("Object Detection Using pretained inception V3 Model")
  st.subheader(' Upload a video with size of 5mb or less'.title())
  main()